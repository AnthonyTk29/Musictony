...
function cargarInfo(e){
    ...
    if (e.target.classList.contains('playEstudiar')){
        ...
        descripcionPlay='la mejor play list para estudiar';
        ...
        descripcionPlay='la mejor play list para rockear';
        ...
        titlePlay='Playlist para Deporte';
        descripcionPlay='la mejor play list para deporte';
        ...
        jsonurl='assets/musicJSON/perreo.json';
        titlePlay='Playlist para Reggaeton';
        descripcionPlay='la mejor play list para el perreo';
        srcImg='assets/img/perreo.png';
        album.style.background="linear-gradient(to right, rgba(2,2,2,0.726) 15%, rgba(8,8,8,0.829)),url(assets/img/perreo.png)";
    
    }else if(e.target.classList.contains('playSalsa')){
        jsonurl='assets/musicJSON/salsa.json';
        titlePlay='Playlist para salsa';
        descripcionPlay='la mejor play list para Salsa';
        srcImg='assets/img/Salsa.jpg';
        album.style.background="linear-gradient(to right, rgba(2,2,2,0.726) 15%, rgba(8,8,8,0.829)),url(assets/img/Salsa.jpg)";
    
    }else if(e.target.classList.contains('playProgramar')){
        jsonurl='assets/musicJSON/programar.json';
        titlePlay='Playlist para programar';
        descripcionPlay='la mejor play list para Programar';
        srcImg='assets/img/programar.png';
        album.style.background="linear-gradient(to right, rgba(2,2,2,0.726) 15%, rgba(8,8,8,0.829)),url(assets/img/programar.png)";
        ...
        .then(function(data){
            ...
            data.forEach(music => {
                ...
                <li class="music">
                    ...
                    <a href="#" id="${music.id}" class="btn play-music">
...
function reproducirMusica(e) {
    if (e.target.parentElement.classList.contains('play-music')) {
        ...
        <audio src="${urlM}"  controls autoplay><input type="text" value="${urlM}" style="display: none;"></audio>
...
function siguienteAtras(musica, reproducida) {
    controles.innerHTML = `<a href="#" class="btn control atras"><i class="fas fa-backward"></i></a>
    <audio src="${musica}" controls autoplay><input type="text" value="${musica}" style="display: none;"></audio>
    <a href="#" class="btn control siguiente"><i class="fas fa-forward"></i></a>`;
